...
// 动态色彩
let ACTIVE_COLORS=[[245,169,184],[255,255,255],[91,206,250]];
let ACTIVE_N=3;
...
const T_ZH={
  ...
  randColor:'🎲 随机选色',randSeq:'🎲 随机序',paletteHint:'左键色块切换 · 右键弹出选择',
...
const T_EN={
  ...
  symMode:'Symmetry Mode',symOpt:['X-Symmetry','Translate','Y-Symmetry','Central Symmetry'],
  ...
  reset:'Regenerate',exportImg:'Export PNG',exportJSON:'Export JSON',importJSON:'Import JSON',
