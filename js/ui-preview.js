...
document.getElementById('zoomOutBtn').title=T.zoomOut;document.getElementById('zoomInBtn').title=T.zoomIn;document.getElementById('fitBtn').title=T.zoomFitTitle;const vm=document.getElementById('viewMode');vm.innerHTML='<option value="all">'+T.allStrips+'</option>';for(let i=0;i<6;i++)vm.innerHTML+='<option value="'+i+'">'+T.stripN+(i+1)+'</option>';scheduleRender();}
